...
export const CreateMerchantValidation = z.object({
  ...
  referencePhone: z.string().min(10, "Reference phone must be at least 10 digits"),
...
export const UpdateMerchantValidation = z.object({
  ...
  referencePhone: z.string().min(10, "Reference phone must be at least 10 digits").optional(),
